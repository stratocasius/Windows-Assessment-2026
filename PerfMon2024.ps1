### 11/25/2024 - Updated output location to C:\programdata\Microsoft\IntuneManagementExtension\Logs
...
$collectorSetXml | Out-File -FilePath "C:\programdata\Microsoft\IntuneManagementExtension\Logs\JL-Process-HardwareAnalysis.xml"
start-sleep 5
# Import the data collector set from the JL-Process-HardwareAnalysis.xml file and save it as name JL-Process-HW-Stats
$logmanCommand = "logman import -n JL-Process-HW-Stats-xml C:\programdata\Microsoft\IntuneManagementExtension\Logs\JL-Process-HardwareAnalysis.xml"
