### 01/10/2025 - Updated output location to C:\programdata\Microsoft\IntuneManagementExtension\Logs
### 08/13/2023 - Updated processes and analysis of key hardware components - Citrix-JabraDirect replaced Netskope-Rapid7.
$collectorSetXml = @"
...
<DataCollectorSet>
	...
	<LatestOutputLocation>C:\programdata\Microsoft\IntuneManagementExtension\Logs\PerfMonLogs</LatestOutputLocation>
	<Name>JL-Process-HardwareAnalysis</Name>
	<OutputLocation>C:\programdata\Microsoft\IntuneManagementExtension\Logs\PerfMonLogs\JL-Process-HardwareAnalysis</OutputLocation>
	<RootPath>C:\programdata\Microsoft\IntuneManagementExtension\Logs\PerfMon</RootPath>
	<Segment>0</Segment>
	...
	<PerformanceCounterDataCollector>
		...
		<LatestOutputLocation>C:\programdata\Microsoft\IntuneManagementExtension\Logs\PerfMonLogs\DataCollector01.blg</LatestOutputLocation>
		<DataSourceName>
		</DataSourceName>
...
$logmanExport = "relog DataCollector01.blg -f CSV -o C:\programdata\Microsoft\IntuneManagementExtension\Logs\DataCollector01.csv"
